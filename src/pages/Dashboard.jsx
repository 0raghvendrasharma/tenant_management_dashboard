...
const Dashboard = () => {
  ...
  // Set form data to selected tenant
...
return (
  <div className="p-4">
    ...
    <div className="flex items-center mt-2">
      ...
      {formData.id && (
        <button
          type="button" className= " ms-2 bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700"
          onClick={() => setFormData({ name: '', email: '', role: 'admin' })}
